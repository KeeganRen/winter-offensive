...
namespace svo {
    ...
    FrameHandlerBase::UpdateResult FrameHandlerMono::processFrame()
    {
        ...
        if (!depth_frame) {
            ...
            dense_align_n_tracked = dense_align.run(depth_frame, new_frame_, edge_ksi);
...
#endif
        Matrix<double, 6, 1> corner_ksi;
        new_frame_->T_f_w_ = last_frame_->T_f_w_;
        // sparse image align
        SVO_START_TIMER("sparse_img_align");
        SparseImgAlign img_align(Config::kltMaxLevel(), Config::kltMinLevel(),
                30, SparseImgAlign::GaussNewton, false, false);
        size_t img_align_n_tracked = img_align.run(last_frame_, new_frame_, corner_ksi);
            ...
            FramePtr ref_keyframe)
    {
        ...
        SparseImgAlign img_align(Config::kltMaxLevel(), Config::kltMinLevel(),
                30, SparseImgAlign::GaussNewton, false, false);
        img_align_n_tracked = img_align.run(ref_keyframe, new_frame_, corner_ksi);
    ...
    FramePtr FrameHandlerMono::activeFrame()
    {
        return depth_map_manager_->getActiveKeyframe();
    }
